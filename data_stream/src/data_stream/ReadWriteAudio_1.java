...
public class ReadWriteAudio_1 extends javax.swing.JFrame {
    ...
    private void btreadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btreadActionPerformed
        ...
        int res = chooser.showOpenDialog(ReadWriteAudio_1.this);
        if(res == JFileChooser.APPROVE_OPTION){
            ...
            try{
                ...
                Logger.getLogger(ReadWriteAudio_1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReadWriteAudio_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReadWriteAudio_1().setVisible(true);
            }
        });
    }
