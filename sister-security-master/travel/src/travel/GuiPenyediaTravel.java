 ...
 * @author ozora
 */
public class GuiPenyediaTravel extends JFrame
{
     private static final long serialVersionUID = 1L;

    private PenyediaTravel myAgent;

    private JTextField titleField, jbField, priceField;

    GuiPenyediaTravel (PenyediaTravel a) {
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ev) {
                try {
                    ...
                    JOptionPane.showMessageDialog(GuiPenyediaTravel.this, "Invalid values. " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        p = new JPanel();
